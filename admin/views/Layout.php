...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index.php" class="logo">
            ...
            <span href="index.php" class="logo-lg"><b> <img src="../assets/frontend/100/047/633/themes/517833/assets/1684312014banner-2023.png"  alt="User Image"></b></span>
        </a>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="../assets/frontend/100/047/633/themes/517833/assets/1684312014banner-2023.png" class="img-circle" alt="User Image">
                </div>
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li>
                    <a href="index.php?controller=users">
                        <i class="fa fa-code"></i> <span>Admin</span>
                    </a>
                </li>
                <li>
